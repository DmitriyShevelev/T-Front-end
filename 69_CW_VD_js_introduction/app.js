...
// console.log(`(12.5) === new Number(12.5) is ${12.5 === new Number(12.5)}`);
// console.log(`(12.5) === new Number(12.5) with JSON conversion is ${JSON.stringify(new Number(12.5)) === JSON.stringify(new Number(12.5))}`);
...
// ar.name = "Andrey";
// ar.length = 0;
// console.log(ar[1_000_000], ar.name);
// ar[0] = 123;
// ar[1] = 2;
...
//01.12.2021: distinct function ptoperties
...
function displayOccurrences(array) {
    ...
    Object.entries(obj).sort((e1, e2) => {
        const res = e2[1] - e1[1];
        return res ? res : e1[0].localeCompare(e2[0]);
